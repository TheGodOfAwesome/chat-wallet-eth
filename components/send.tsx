...
const Send = () => {
    ...
    let amt:string = router.query["amt"] ? router.query["amt"] as string : "";
    let addr:string = (router.query["addr"]) ? router.query["addr"] as string : "";
    let ch:string = router.query["chain"] ? router.query["chain"] as string : "";
                    ...
                    <div>
                        ...
                        }
                        {
                            ...
                            <>
                                ...
                                <button onClick={!account ? connectWeb3 : sendTokens}>
                                    Send Tokens
                                </button>
                            </>
                        }
